...
import (
	"fmt"
	"github.com/d-sense/go-graphql-api/gql"
	"github.com/d-sense/go-graphql-api/postgres"
	"github.com/d-sense/go-graphql-api/server"
...
func initializeAPI() (*chi.Mux, *postgres.Db) {
	...
	db, err := postgres.New(
		postgres.ConnString("localhost", 5432, "postgres", "go_graphql_db", "Sholah"),
	)
	if err != nil {
		log.Fatal(err)
	}
